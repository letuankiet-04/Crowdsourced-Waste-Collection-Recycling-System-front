  ...
  return (
    <RoleSidebar
      ...
      navItems={[
        ...
        <SidebarNavItem key="feedback" to="#" className="text-lg" icon={<MessageSquare className="h-6 w-6" />}>
          Review Feedback
        </SidebarNavItem>,
        <SidebarNavItem key="users" to="#" className="text-lg" icon={<Users className="h-6 w-6" />}>
          User Management
        </SidebarNavItem>,
