                       ...
                       <tr className="hover:bg-gray-50/50 transition-colors">
                          <td className="py-4 px-6">
                             <div className="flex items-center gap-4">
                                ...
                                <div>
                                   <div className="font-bold text-gray-900">Wait API (Title)</div>
                                   <div className="text-xs text-gray-500">Wait API (Vendor)</div>
                                </div>
                             </div>
                          </td>
                          <td className="py-4 px-6 text-sm text-gray-500">Wait API (Date)</td>
                          <td className="py-4 px-6">
